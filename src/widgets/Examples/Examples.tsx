...
import ReadAndBurnImage from './assets/readandburn.jpg'
...
export default function Examples() {
	return (
		<div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
			...
			<div className='flex flex-col gap-2 justify-start max-w-[400px] m-auto'>
				<Link
					href='https://readandburn.com'
					target='_blank'
				>
					<Image
						src={ReadAndBurnImage}
						alt='ReadAndBurn.com screenshot'
						loading='eager'
						width={450}
						height={450}
						sizes='450px'
				...
				<h3 className='text-sm font-semibold'>ReadAndBurn.com</h3>
				<p className='text-sm font-light'>Minimalistic service for exchanging disposable messages.</p>
				<div className='flex flex-row gap-5 items-center justify-start text-xs font-semibold'>
					<div>NextJs</div>
					<div>Tailwind</div>
					<div>Supabase</div>
